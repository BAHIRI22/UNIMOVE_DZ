...
export default function BusinessModelPage() {
  ...
  const partners = [
    ...
    { icon: Wrench, name: language === 'ar' ? 'الصيانة' : 'Maintenance', desc: language === 'ar' ? 'دفع مرن' : 'Services techniques' },
    ...
    { icon: CreditCard, name: language === 'ar' ? 'دفع مرن' : 'Paiement électronique', desc: language === 'ar' ? 'نص عربي صحيح' : 'Solutions paiement' },
  ...
  const activities = [
    ...
    { icon: MapPin, name: language === 'ar' ? 'تتبع GPS' : 'GPS tracking', desc: language === 'ar' ? 'نص عربي صحيح' : 'Position temps réel' },
    { icon: Bell, name: language === 'ar' ? 'إشعارات' : 'Notifications', desc: language === 'ar' ? 'تنبيهات ذكية' : 'Alertes intelligentes' },
    { icon: Users, name: language === 'ar' ? 'إدارة السائقين' : 'Gestion chauffeurs', desc: language === 'ar' ? 'نص عربي صحيح' : 'Équipe professionnelle' },
    ...
    { icon: CreditCard, name: language === 'ar' ? 'دفع مرن' : 'Paiement électronique', desc: language === 'ar' ? 'دفع مرن' : 'Paiement sécurisé' },
    { icon: DollarSign, name: language === 'ar' ? 'دفع مرن' : 'Paiement cash', desc: language === 'ar' ? 'خيارات متعددة' : 'Options multiples' },
  ...
  const valueProposition = [
    ...
    { icon: Clock, name: language === 'ar' ? 'تقليل التأخير' : 'Réduction retards', desc: language === 'ar' ? 'نص عربي صحيح' : 'Arrivée à temps' },
    { icon: Wifi, name: language === 'ar' ? 'Wi-Fi مدمج' : 'Wi-Fi embarqué', desc: language === 'ar' ? 'إنترنت عالي السرعة' : 'Internet haute vitesse' },
    { icon: Bell, name: language === 'ar' ? 'إشعارات ذكية' : 'Notifications intelligentes', desc: language === 'ar' ? 'نص عربي صحيح' : 'Alertes temps réel' },
    ...
    { icon: Clock, name: language === 'ar' ? 'نص عربي صحيح' : 'Gain de temps', desc: language === 'ar' ? 'نص عربي صحيح' : 'Haute efficacité' },
    ...
    { icon: Plane, name: language === 'ar' ? 'رحلات سياحية' : 'Voyages touristiques', desc: language === 'ar' ? 'نص عربي صحيح' : 'Découverte Algérie' },
  ...
  const relationships = [
    ...
    { icon: Bell, name: language === 'ar' ? 'إشعارات ذكية' : 'Notifications intelligentes', desc: language === 'ar' ? 'نص عربي صحيح' : 'Alertes utiles' },
    ...
    { icon: MessageCircle, name: language === 'ar' ? 'دردشة مباشرة' : 'Chat support', desc: language === 'ar' ? 'دفع مرن' : 'Conversation instantanée' },
  ...
  const resources = [
    ...
    { icon: Users, name: language === 'ar' ? 'السائقون' : 'Chauffeurs', desc: language === 'ar' ? 'دفع مرن' : 'Professionnels certifiés' },
    ...
    { icon: Cog, name: language === 'ar' ? 'نص عربي صحيح' : 'Équipe technique', desc: language === 'ar' ? 'خبراء مبدعون' : 'Experts innovants' },
