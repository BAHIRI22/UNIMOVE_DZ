...
export default function AboutProjectPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      text: language === 'ar'
        ? 'UNIMOVE-DZ تقدم منصة رقمية للحجز، QR، تتبع GPS، إشعارات، اشتراكات، ودفع مرن داخل تجربة موحدة.'
    ...
    },
    {
      ...
      text: language === 'ar'
        ? 'بطاقات رقمية، تتبع الرحلات، معلومات واضحة، وسائقون منظمون يرفعون الثقة والأمان داخل النقل الجامعي.'
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="text-4xl font-black md:text-5xl">
                {language === 'ar' ? 'الابتكار في خدمة النقل الجامعي' : 'L’innovation au service de la mobilité universitaire'}
              </h2>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <div className="mt-6 space-y-3 text-lg font-semibold text-emerald-50">
                ...
                <p>{language === 'ar' ? 'الإشراف: الدكتورة رمدوم نورة' : 'Supervision : Dr. RMDOM Noura'}</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl font-black md:text-4xl">
