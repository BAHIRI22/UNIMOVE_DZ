                ...
                {language === 'ar' ? (
                  <div className="space-y-12" dir="rtl">
                    ...
                    <div>
                      ...
                      <p className="text-slate-700 leading-[2.2] text-xl md:text-2xl font-medium">
                        يهدف التطبيق إلى تسهيل التنقل الجامعي اليومي عبر نظام حجز ذكي، وسائل نقل منظمة، مواعيد دقيقة، وخدمات حديثة مثل الواي فاي داخل الحافلات والسيارات، مع توفير عدة طرق للدفع بما في ذلك الدفع الإلكتروني والدفع نقدا عند الركوب.
                      </p>
                    </div>
